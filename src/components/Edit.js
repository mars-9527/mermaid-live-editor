...
import { Row, Col, Input, Tag, Card, Divider } from 'antd'
  ...
  render () {
    ...
    return <div>
      ...
      <Row gutter={16}>
        <Col span={8}>
          <Card title='Code'>
            <Input.TextArea autosize={{ minRows: 24, maxRows: 16 }} spellCheck={false} value={this.json.code} onChange={this.onCodeChange} />
          </Card>
